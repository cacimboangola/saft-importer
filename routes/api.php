...
use App\Http\Controllers\ConfigListController;
...
use App\Http\Controllers\UsersOnlineStoreController;
...
Route::resource('users-online-stores', UsersOnlineStoreController::class);
...
Route::get('docs/orders/{invoiceId}', [DocsController::class,'getDocsDraftsOrderDetailsWithLinesByID']);
Route::get('get-qrcode', [DocsController::class,'getQrCode'])->name('getQrCode');
Route::get('docs/onlines/user/{user_id}/expositores/encomendas', [DocsController::class,'getDocsDraftOrderDetailsWithLinesExpositores']);
...
Route::get('docs/v1/analytics/{nif}', [DocsController::class,'analytics']);
...
Route::post('sendSocket', [Util::class, 'sendMessageWebSocketApi'])->name('sendMessageWebSocket');
...
Route::get('config-list/{companyID}', [ConfigListController::class, 'configListForCompany'])->name('list-config-company');
Route::get('config-list', [ConfigListController::class, 'index'])->name('list-config');